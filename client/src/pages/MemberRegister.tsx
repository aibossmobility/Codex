    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Create your member portal account</p>
        </div>
        ...
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
          ...
          <h2 className="text-white font-bold text-lg text-center mb-6">Member Registration</h2>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          ...
          <a href="/member-login" className="hover:text-gray-400 transition-colors">
            Sign in
          </a>
        </p>
